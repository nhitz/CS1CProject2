...
#include "../../Totally-not-russia-master/Totally-not-russia-master/project/dialogcustomer.h"
...
struct qt_meta_stringdata_DialogCustomer_t {
    QByteArrayData data[1];
    char stringdata0[15];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_DialogCustomer_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_DialogCustomer_t qt_meta_stringdata_DialogCustomer = {
    {
QT_MOC_LITERAL(0, 0, 14) // "DialogCustomer"
...
const QMetaObject DialogCustomer::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_DialogCustomer.data,
      qt_meta_data_DialogCustomer,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DialogCustomer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DialogCustomer.stringdata0))
